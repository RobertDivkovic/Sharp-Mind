...
class TestForms(TestCase):
    ...
    def test_contact_form_valid(self):
        ...
        self.assertTrue(form.is_valid(),
                        "ContactForm should be valid with all fields filled")
    ...
    def test_contact_form_invalid(self):
        ...
        self.assertFalse(form.is_valid(), "Form should invalid without fields")
    ...
    def test_post_form_valid(self):
        ...
        self.assertTrue(form.is_valid(),
                        "PostForm should be valid with correct data")
    ...
    def test_post_form_invalid(self):
        ...
        self.assertFalse(form.is_valid(),
                         "PostForm should be invalid without a title")

    def test_profile_form_valid(self):
        """Test that the ProfileForm is valid with a profile picture."""
        form = ProfileForm(data={'profile_picture': None})
        self.assertTrue(form.is_valid(),
                        "ProfileForm should be valid with valid data")

    def test_profile_form_invalid(self):
        """Test that the ProfileForm is
        valid even with no data (if optional)."""
        form = ProfileForm(data={})
        self.assertTrue(form.is_valid(), "Frmshould be valid if p_pic optinal")
